...
# Commerce_HOST
Set-EnvFileVariable "BIZFX_HOST" -Value "bizfx.$($HostName).localhost"
Set-EnvFileVariable "AUTHORING_HOST" -Value "authoring.$($HostName).localhost"

Set-EnvFileVariable "SHOPS_HOST" -Value "shops.$($HostName).localhost"
Set-EnvFileVariable "MINIONS_HOST" -Value "minions.$($HostName).localhost"
Set-EnvFileVariable "OPS_HOST" -Value "ops.$($HostName).localhost"
...
Add-HostsEntry "bizfx.$($HostName).localhost"
Add-HostsEntry "authoring.$($HostName).localhost"
Add-HostsEntry "shops.$($HostName).localhost"
Add-HostsEntry "minions.$($HostName).localhost"
Add-HostsEntry "ops.$($HostName).localhost"
